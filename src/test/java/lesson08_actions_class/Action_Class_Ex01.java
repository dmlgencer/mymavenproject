package lesson08_actions_class;
...
public class Action_Class_Ex01 {
    ...
    public void test01(){
        /*
               ...
               9.  Fill details: First name, Last name, Company, Adress, Address2, Country, State, City, Zipcode, Mobile Number
        ...
        //3. Click on 'Signup / Login' button
        WebElement sigUp = driver.findElement(By.xpath("//a[text()=' Signup / Login'] "));
        Actions actions = new Actions(driver);
        actions.click(sigUp).perform();
